classdef DTDD_SimulationApp < handle
    %
    % Usage:
    %     app.DTDD_SimulationApp
    ...
    properties (Constant)
        AppPathBase = {'/DTDD_Simulation/code'};
        AppClass = 'DTDD_SimulationApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = DTDD_SimulationApp()
        ...
        function startApp(obj)
            ...
            mlock;
            DTDD_SimulationApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'DTDDGui')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong DTDDGui
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'DTDDGui').getString, ...
            ...
            if nargout(@DTDDGui) == 0
                eval('DTDDGui');
            else
                obj.AppHandle = eval('DTDDGui');
            end
